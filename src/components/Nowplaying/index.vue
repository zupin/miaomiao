...
export default {
    ...
    activated () {
        ...
        // console.log('123')
        this.axios({
            url: `https://m.maizuo.com/gateway?cityId=${cityId}&pageNum=1&pageSize=10&type=1&k=671330`,
            headers: {
            ...
            if ( msg === 'ok' ) {
                ...
                /* this.$nextTick(() => {
                    var scroll = new BScroll( this.$refs.movies_body , {
                        tap: 'tap',
                        probeType: 1
                    })
                    ...
                    scroll.on('touchEnd',(pos) => {
                        ...
                        if (pos.y > 30) {
                            this.axios({
                                url: 'https://m.maizuo.com/gateway?cityId=110100&pageNum=1&pageSize=10&type=1&k=671330',
                                headers: {
                                    'X-Client-Info': '{"a":"3000","ch":"1002","v":"5.0.4","e":"16332646631279548066889729","bc":"110100"}',
                                    'X-Host': 'mall.film-ticket.film.list'
                                }
