    ...
    <div id="detailContainer" class="slide-enter-active">
		...
		<div v-else id="content" class="contentDetail">
            ...
            <div class="detail_list">
				...
				<!-- <div class="detail_list_bg" :style="{ 'background-image' : 'url(' + detailMovie.poster.replace(/w\.h/,148.208) + ')' }"></div> -->
				<div class="detail_list_filter"></div>
				<div class="detail_list_content">
					<div class="detail_list_img">
						<!-- <img :src="detailMovie.poster | setWH('148.208)'" alt=""> -->
            ...
            <div class="detail_player swiper-container" ref="detail_player">
				<ul class="swiper-wrapper">
					<li class="swiper-slide" v-for="(item,index) in detailMovie.actors" :key="index">
						<div>
...
export default {
    ...
    mounted () {
        ...
        this.axios({
            url: `https://m.maizuo.com/gateway?filmId=${this.movieId}&k=2143139`,
            headers: {
...
<style scoped>
    ...
    .detail_list .detail_list_info p{ width: 250px;color:white; line-height: 20px; font-size: 14px; color:#ccc;overflow: hidden;white-space: nowrap;text-overflow:ellipsis;}
    /* .detail_list .detail_list_content p{font-size: 13px; color:white; line-height: 22px; width:200px; overflow: hidden; white-space: nowrap; text-overflow:ellipsis;} */
